...
export class PromptService {
    constructor(bucketName = process.env.PROMPTS_S3_BUCKET || 'nova-sonic-prompts', cacheTimeout = parseInt(process.env.PROMPT_CACHE_TIMEOUT || '300000') // 5 minutes default
    ) {
     ...
     */
    async getSystemPrompt(assistantName) {
     ...
     */
    async loadFromS3(assistantName) {
     ...
     * @param assistantName - Name of the assistant
     */
    clearCacheForAssistant(assistantName) {
        const cacheKey = this.getCacheKey(assistantName);
     ...
     */
    async preloadAssistants(assistantNames) {
