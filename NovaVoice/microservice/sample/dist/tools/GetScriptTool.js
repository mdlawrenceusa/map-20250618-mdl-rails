...
exports.GetScriptTool = void 0;
var Tool_1 = require("./Tool");
var GetScriptTool = /** @class */ (function (_super) {
    __extends(GetScriptTool, _super);
    function GetScriptTool() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GetScriptTool.execute = function (toolUseContent, messagesList) {
        return __awaiter(this, void 0, void 0, function () {
            var n, scripts, content;
            var _a;
            return __generator(this, function (_b) {
                n = (_a = JSON.parse(toolUseContent.content)) === null || _a === void 0 ? void 0 : _a.number;
                if (!n) {
                    n = 0;
                }
                console.log("n", n);
    ...
    GetScriptTool.id = "getscript";
    GetScriptTool.schema = {
        type: "object",
        properties: {
            number: {
                type: "number",
    ...
    return GetScriptTool;
}(Tool_1.Tool));
exports.GetScriptTool = GetScriptTool;
exports.default = GetScriptTool;
