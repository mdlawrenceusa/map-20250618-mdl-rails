...
(function (FlowValidationDetails) {
    FlowValidationDetails.visit = (value, visitor) => {
        ...
        if (value.missingLoopInputNode !== undefined)
            return visitor.missingLoopInputNode(value.missingLoopInputNode);
        if (value.missingLoopControllerNode !== undefined)
            return visitor.missingLoopControllerNode(value.missingLoopControllerNode);
        if (value.multipleLoopInputNodes !== undefined)
            return visitor.multipleLoopInputNodes(value.multipleLoopInputNodes);
        ...
        if (value.invalidLoopBoundary !== undefined)
            return visitor.invalidLoopBoundary(value.invalidLoopBoundary);
        return visitor._(value.$unknown[0], value.$unknown[1]);
    };
...
export const InlineCodeFlowNodeConfigurationFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.code && { code: SENSITIVE_STRING }),
});
export const KnowledgeBasePromptTemplateFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.textPromptTemplate && { textPromptTemplate: SENSITIVE_STRING }),
});
export const KnowledgeBaseOrchestrationConfigurationFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const KnowledgeBaseFlowNodeConfigurationFilterSensitiveLog = (obj) => ({
    ...obj,
    ...(obj.promptTemplate && { promptTemplate: KnowledgeBasePromptTemplateFilterSensitiveLog(obj.promptTemplate) }),
    ...
    ...(obj.orchestrationConfiguration && {
        orchestrationConfiguration: KnowledgeBaseOrchestrationConfigurationFilterSensitiveLog(obj.orchestrationConfiguration),
    }),
});
export const LoopControllerFlowNodeConfigurationFilterSensitiveLog = (obj) => ({
    ...obj,
...
export const FlowValidationDetailsFilterSensitiveLog = (obj) => {
    ...
    if (obj.missingLoopInputNode !== undefined)
        return { missingLoopInputNode: obj.missingLoopInputNode };
    if (obj.missingLoopControllerNode !== undefined)
        return { missingLoopControllerNode: obj.missingLoopControllerNode };
    if (obj.multipleLoopInputNodes !== undefined)
        return { multipleLoopInputNodes: obj.multipleLoopInputNodes };
    if (obj.multipleLoopControllerNodes !== undefined)
        return { multipleLoopControllerNodes: obj.multipleLoopControllerNodes };
    if (obj.loopIncompatibleNodeType !== undefined)
        return { loopIncompatibleNodeType: obj.loopIncompatibleNodeType };
    if (obj.invalidLoopBoundary !== undefined)
        return { invalidLoopBoundary: obj.invalidLoopBoundary };
    if (obj.$unknown !== undefined)
        return { [obj.$unknown[0]]: "UNKNOWN" };
};
