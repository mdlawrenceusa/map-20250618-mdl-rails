...
class OutboundCallManager {
    ...
    handleSimpleAnswer(req, res) {
        ...
        const ncco = [
            {
                action: 'talk',
                text: (callInfo === null || callInfo === void 0 ? void 0 : callInfo.message) || 'Hello, this is a test call from Nova Sonic.',
                voiceName: 'Amy'
            },
            {
                action: 'record',
    ...
    handleAIAnswer(req, res) {
        ...
        const ncco = [
            {
                action: 'talk',
                text: (callInfo === null || callInfo === void 0 ? void 0 : callInfo.message) || 'Hello, I am an AI assistant. Please wait while I connect you to our speech system.',
                voiceName: 'Amy'
            },
            {
                action: 'connect',
