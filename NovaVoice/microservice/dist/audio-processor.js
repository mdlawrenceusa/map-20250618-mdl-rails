...
class AudioProcessor {
    constructor() {
        ...
        logger_1.logger.info('AudioProcessor initialized');
    }
    /**
     * Convert L16 PCM audio from Vonage to format expected by Nova Sonic
     */
    convertVonageToNovaSonic(audioData) {
     ...
     */
    convertNovaSonicToVonage(audioData) {
     ...
     */
    generateSilence(durationMs, sampleRate = 16000) {
